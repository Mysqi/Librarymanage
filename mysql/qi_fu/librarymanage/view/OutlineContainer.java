...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(AlertUtil.dpToPx(getResources(), 2));
        mOutlinePaint.setColor(getResources().getColor(R.color.blue));
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = AlertUtil.dpToPx(getResources(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = AlertUtil.dpToPx(getResources(), 5);

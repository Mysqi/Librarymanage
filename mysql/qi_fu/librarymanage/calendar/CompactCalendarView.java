...
public class CompactCalendarView extends View {
	...
	private final GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() {
		...
		public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
			if (!compactCalendarController.shouldShowNextMonth() && distanceX>0) {
				return false;
			}
	...
	public CompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		compactCalendarController = new CompactCalendarController(new Paint(), new OverScroller(getContext()),
				...
				Locale.getDefault(), TimeZone.getDefault(), this);
	...
	public void adjustHeight() {
		postDelayed(new Runnable() {
			@Override
			public void run() {
				int height = compactCalendarController.getActualHeight();
				ResizeAnimation resizeAnimation = new ResizeAnimation(CompactCalendarView.this, height);
				resizeAnimation.setDuration(300);
				startAnimation(resizeAnimation);
				compactCalendarController.setTargetHeight(height);
			}
		}, 200);
	}
	...
	public void setCurrentSelectedDayTextColor(int currentSelectedDayBackgroundColor) {
	...
	public void showCalendar(){
		...
		compactCalendarController.setIsShown(true);
	}

	public void hideCalendar(){
		checkTargetHeight();
		animationHandler.closeCalendar();
		compactCalendarController.setIsShown(false);
	}
...
//		checkTargetHeight();
	...
	public boolean isShown() {
		return compactCalendarController.isShown();
	}
